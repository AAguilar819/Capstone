...
function displayContents(array) {
    for (var i = 0; i < document.getElementsByTagName("span").length; i++) {
        ...
        } // else if (document.getElementsByTagName("span")["id"].length != 0) {
        // document.getElementsByTagName("span")[i].style.padding = "0px";
        // document.getElementsByTagName("span")[i].style.border = "0px";
        // document.getElementsByTagName("span")[i].style.backgroundColor = "none";
        // }
...
function writeSessionValues() {
    document.getElementById("name").textContent = sessionStorage.getItem("confName").value;
    document.getElementById("email").textContent = sessionStorage.getItem("confMail").value;
    document.getElementById("phone").textContent = sessionStorage.getItem("confPhone").value;
    document.getElementById("product").textContent = sessionStorage.getItem("confProduct").value;
